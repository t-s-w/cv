...
* Python 3.7:
    ...
    - Code documentation (Not a skill per se, but just pointing out that I am familiar with conventions)
...
### August 2019 - October 2019: Informetis Europe

#### Data Analysis intern

<a href = "https://www.informetis.com/en/">Informetis</a> is a company which originated in Japan specialising in assisted living through machine learning and data science, currently early in its expansions in to Europe.

I was tasked with trying to find a model that automatically detected gradual long-term pattern deviations in behaviour of occupants to hopefully spot cases of worsening dementia/depression early. It was a vast dataset with a lot of insight into how households behave, and I learned a lot from this experience.
